$(document).ready(function(){
	...
	let jlhsoal=0;
	function tampil(){
		let url = "../../assets/json/consomean2.json";
...
$(document).ready(function(){
	function tampil2(){
        let url = "../../assets/json/latihan_mean2.json";
...
function cobamean(){
	document.getElementById("containermodus").hidden = false;
	document.getElementById("cmean2").style="border:5px solid rgb(159,85,212,0.5);border-bottom: none;background-color: white;";
	document.getElementById("cmean1").style = "background-color:rgb(159,85,212,0.5);border:1px solid white;";
